export const countriesInfo = [
  ...
  },
  {
    name: 'BUGARSKA',
    info:
      'Državljani Srbije mogu da uđu u Bugarsku. Neophodan je negativan PCR test, ne stariji od 72 sata. \nOd obaveze posedovanja negativnog PCR testa izuzeti su: 1) državljani Srbije koji tranzitiraju, bez zadržavanja; 2) pogranični radnici; 3) vozači autobusa, angažovani na međunarodnom prevozu putnika; 4) vozači teretnih vozila, angažovani na međunarodnom prevozu robe i tereta; 5) posade plovila; 6) posade vazduhoplova, angažovane na letovima do i sa bugarskih javnih aerodroma i lica koja tehnički opslužuju vazduhoplove; 7) učenici i studenti koji žive u Srbiji i svakodnevno ili najmanje jednom nedeljno putuju u Bugarsku radi školovanja, kao i učenici i studenti koji žive u Bugarskoj i svakodnevno ili najmanje jednom nedeljeno putuju u Srbiju radi školovanja. \nDržavljani Srbije, koji u Bugarskoj imaju regulisan boravak, a na ulasku u zemlju nemaju negativan PCR test, podležu obavezi karantina u kućnim uslovima u trajanju od 10 dana. Karantin se može prekinuti ako se u roku od 24 sata po povratku u Bugarsku uradi test, i isti bude negativan. \nSrpski državljani mogu iz Srbije ući u Bugarsku samo preko graničnih prelaza Kalotina i Vrška Čuka. Ovo ograničenje se ne odnosi na lica koja su oslobođena od obaveze posedovanja negativnog PCR testa.',
  },
  {
    name: 'BURKINA FASO',
    info:
  ...
  },
  {
    name: 'ESTONIJA',
    info:
      'Državljani Srbije ne mogu da uđu u Estoniju, osim ako dolaze zbog zaposlenja ili studiranja (u tom slučaju, obavezan je karantin u trajanju od 10 dana, kao i dva PCR testa – odmah po dolasku u Estoniju i nakon 6 dana karantina).  \nDozvoljava se ulazak u Estoniju licima sa regulisanim boravkom ili dugoročnom vizom, kao i članovima njihovih porodica, koja dolaze iz zemalja članica EU, Šengen zone, UK, Andore, Monaka, San Marina i Vatikana, kao i državljanima trećih država sa liste EU (lista dostupna na:  <a href="https://vm.ee/en/information-countries-and-self-isolation-requirements-passengers" class="text-info" target="_blank" rel="noopener noreferrer">https://vm.ee/en/information-countries-and-self-isolation-requirements-passengers</a> ), pod uslovom da ne ispoljavaju simptome infekcije virusom COVID-19. Samoizolacija u trajanju od 10 dana obavezna je za sva lica koja ispoljavaju simptome infekcije, kao i za sva lica koja dolaze iz država u kojima je u prethodnih 14 dana registrovano više od 150 novih slučajeva infekcije na 100.000 stanovnika. U slučaju putovanja ili tranzita preko UK, obavezan je i negativan test urađen najviše 72 sata pre putovanja. Državljani stranih zemalja koje nisu gore navedene mogu ući u Estoniju radi zaposlenja ili studija, uz obavezan karantin od 10 dana i dva testa – odmah po dolasku i nakon 6 dana karantina. Testiranje je omogućeno na aerodromu/u lukama svim licima koja dolaze u Estoniju (za estonske državljane besplatno, za strance po ceni od 52 evra). Putnici mogu, ukoliko žele, da skrate period samoizolacije obavljajući dva PCR testa (prvi najranije 72 sata pre putovanja, drugi nakon šest dana samoizolacije po dolasku u Estoniju). Više informacija dostupno je na internet adresi:  <a href="https://vm.ee/en/information-countries-and-self-isolation-requirements-passengers" class="text-info" target="_blank" rel="noopener noreferrer">https://vm.ee/en/information-countries-and-self-isolation-requirements-passengers</a> . Samoizolacija i testiranje nisu potrebni ukoliko putnici poseduju dokaz da su preležali virus ili da su vakcinisani u poslednjih 6 meseci (detaljnije na adresi:  <a href="https://vm.ee/en/coronavirus-2019-ncov" class="text-info" target="_blank" rel="noopener noreferrer">https://vm.ee/en/coronavirus-2019-ncov</a> ).  Najkasnije 24 sata pre putovanja u Estoniju (osim u slučaju direktnog tranzita), neophodno je popuniti elektronski formular dostupan na internet adresi:  <a href="https://iseteenindus.terviseamet.ee/" class="text-info" target="_blank" rel="noopener noreferrer">https://iseteenindus.terviseamet.ee/</a> .',
  },
  {
    name: 'ETIOPIJA',
    info:
  ...
  },
  {
    name: 'ISLAND',
    info:
      'Državljani Srbije ne mogu da uđu na Island osim lica određenih kategorija u srodstvu sa osobom koja živi na Islandu. Detaljnije informacije se mogu naći na linku:  <a href="https://www.logreglan.is/english/regarding-travel-restrictions-to-iceland-as-a-result-of-covid-19/" class="text-info" target="_blank" rel="noopener noreferrer">https://www.logreglan.is/english/regarding-travel-restrictions-to-iceland-as-a-result-of-covid-19/</a> . Lica koja mogu da uđu u Norvešku moraju da poseduju negativan PCR test, ne stariji od 72 sata. Po dolasku obavezan je karatntin kao i ponovno testiranje nakon petog dana karantina. Putnici koji mogu da dokumentuju da su vakcinisani protiv COVID-19, kao i lica koja mogu da dokumentuju da su preležali koronu, izuzeti su od obaveze posedovanja negativnog testa kao i mere karantina. Takođe, svi putnici su u obavezi da popune formular za registraciju pre početka putovanja. Popunjavanje formulara ne podrazumeva odobrenje za ulazak. ( <a href="https://visit.covid.is/" class="text-info" target="_blank" rel="noopener noreferrer">https://visit.covid.is/</a> ).',
  },
  {
    name: 'ISTOČNI TIMOR',
    info:
  ...
  },
  {
    name: 'KATAR',
    info:
      'Državljani Srbije mogu da uđu u Katar uz prethodno dobijenu dozvolu preko „Qatar Portal". Po dolasku, obavezno je testiranje na aerodomu „Hamad“ nakon čega sledi jednonedeljni karantin u hotelu.  \nUkoliko se u zemlju ulazi kopnom preko graničnog prelaza Abu Samra iz Saudijske Arabije neophodan je negativan PCR test, ne stariji od 72 sata, a potom hotelski karantin koji se unapred rezerviše preko sajta „Discover Qatar“. \nStrani državljani sa regulisanim boravkom u Kataru i koji su vakcinisani u Kataru protiv COVID-19 mogu, 14 dana od primanja druge doze, putovati u inostranstvo i vratiti se u Katar, uz negativan PCR test pri povratku, bez obaveznog karantina.  \nSvi putnici moraju imati instaliranu aplikaciju „Ehteraz". \nTranzit preko aerodroma Hamad je dozvoljen.',
  },
  {
    name: 'KENIJA',
    info:
  ...
  },
  {
    name: 'LIBAN',
    info:
      'Državljani Srbije mogu ući u Liban. Neophodni su negativan PCR test, ne stariji od 96 sati, polisa međunarodnog zdravstvenog osiguranja koje pokriva COVID-19 lečenje, registracija pre leta za Liban preko sledećih linkova: <a href="https://survey123.arcgis.com/share/988ba32e1b634902ba3b14c3e4f1614d " class="text-info" target="_blank" rel="noopener noreferrer">https://survey123.arcgis.com/share/988ba32e1b634902ba3b14c3e4f1614d </a>   <a href="https://covid.pcm.gov.lb/impactmobile/curfew " class="text-info" target="_blank" rel="noopener noreferrer">https://covid.pcm.gov.lb/impactmobile/curfew </a> \nkao i pruzimanje mobilne aplikacije:  <a href="https://bit.ly/3du0A4c" class="text-info" target="_blank" rel="noopener noreferrer">https://bit.ly/3du0A4c</a> \nNa aerodromu se putnici podvrgavaju PCR testiranju, nako čega se do tri dana provodi u kućnom karantinu, do dobijanja rezultata testa.',
  },
  {
    name: 'LIBERIJA',
    info:
  ...
  },
  {
    name: 'SLOVAČKA',
    info:
      'Državljani Srbije mogu da uđu u Slovačku. Pre ulaska na teritoriju Slovačke neophodno je registrovati se preklo sledećeg linka:  <a href="http://korona.gov.sk/ehranica" class="text-info" target="_blank" rel="noopener noreferrer">http://korona.gov.sk/ehranica</a> . Lica koja dolaze avionom potrebno je da popune i formular koji se može naći u sledećem linku:  <a href="http://www.mindop.sk/covid" class="text-info" target="_blank" rel="noopener noreferrer">http://www.mindop.sk/covid</a> .  \nNakon ulaska na teritoriju Slovačke, sve osobe (osim izuzetaka kao što su vozači kamiona, autobusa i sl.) su u obavezi da budu u izolaciji do dobijanja negativnog PCR testa koji se radi najranije osmog dana izolacije. \nMoguć je tranzit kroz Slovačku ukoliko se poseduje dozvola za boravak u nekoj od država članica EU. Tranzit može da traje do osam sati. Ostalim licima je neophodna dozvola za tranzit.',
  },
  {
    name: 'SLOVENIJA',
    info:
      'Državljani Srbije ili lica koja imaju boravak u Srbiji mogu ući u Sloveniju uz obavezni karantin od 10 dana (sa mogućnošću da urade PCR test u Sloveniji i sa negativnim rezultatom se oslobode daljeg karantina) ili uz posedovanje PCR testa, ne stariji od 48 sati, urađen u Srbiji (u jednoj od institucija Srbije sa spiska čiji se testovi priznaju) ili u jednoj od zemalja EU, odnosno Šengenskog prostora. Negativan rezultat testa izvršenog po metodi HAGT se priznaje ukoliko je urađen u državi članici EU, odnosno državi Šengenskog prostora. \nDržavljani Srbije mogu ući u Sloveniju bez karantina i negativnog testa u sledećim slučajevima: lice koje priloži potvrdu o pozitivnom HAGT ili PCR rezultatu na COVID-19 koji je stariji od 21 dana ali nije stariji od šest meseci; lice koje priloži potvrdu lekara da je preležalo COVID-19 i od početka simptoma nije prošlo više od šest meseci; lice koje priloži potvrdu o vakcinaciji protiv COVID-19 kojim dokazuje da je od primanja druge doze vakcine proizvođača Biontech/ Pfizer proteklo najmanje sedam dana, Moderna najmanje 14 dana i AstraZeneca najmanje 21 dan; lice koje je upućeno na ili sa izvršenja zadataka u sektoru međunarodnog prevoza i to pri prelasku granice dokazuje »Potvrdom za radnike u sektoru međunarodnog prevoza« ili drugim odgovarajućim dokumentom iz kog se može videti da ga je uputio poslodavac; lice koje vrši prevoz robe u Sloveniju ili iz Slovenije u privrednom saobraćaju, kao i za teretni saobraćaj u tranzitu i napušta Sloveniju u roku od 8 sati po prelasku granice; lice koje je zbog medicinskih razloga došlo u Sloveniju sanitetskim vozilom; osobe sa diplomatskim putnim ispravama; dete koje nije navršilo 13 godina i granicu prelazi sa članom uže porodice, koji nije upućen u kućni karantin i nije mu zabranjen ulazak u Sloveniju.  \nZa tranzit kroz Sloveniju neophodno je posedovanje dokaza o ulasku u državu u koju se lice uputilo (boravišna dozvola, overeno pozivno pismo, rezervacija hotela...) i nije potrebno posedovanje negativnog PCR testa. Tranzit može trajati maksimalno šest sati.',
  },
  {
  ...
  },
  {
    name: 'URUGVAJ',
    info:
      'Državljani Srbije ne mogu ući u Urugvaj osim lica koja imaju stalni boravak; nosioci diplomatskih i službenih pasoša koji stupaju na dužnost; lica koja traže spajanje porodice; lica koja dokažu ekonomski i pravni razlog za boravak u Urugvaju. \nLica koja mogu ući u zemlju podležu odgovarajućim sanitarnim procedurama i dobijaju tzv. sanitarni pasoš nakon što elektronski prijave svoje putovanje i dostave negativan PCR test 72 sati pre ulaska u zemlju. Po ulasku u zemlju, obavezan je karantin od 14 dana. Isti može biti skraćen na sedam dana, ukoliko lice sedmog dana dobije negativan rezultat testiranja. Opširnije informacije se mogu dobiti u sledećem linku:   <a href="https://www.gub.uy/ingreso-uruguay-para-extranjeros " class="text-info" target="_blank" rel="noopener noreferrer">https://www.gub.uy/ingreso-uruguay-para-extranjeros </a>',
  },
  {
    name: 'FILIPINI',
    info:
