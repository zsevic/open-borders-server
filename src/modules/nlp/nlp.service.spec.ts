  ...
  it('should classify the countries', async () => {
    const result: CountryInfo[] = [
      ...
      },
      {
        name: 'SIJERA LEONE',
        info:
          'Državljani Srbije mogu da uđu u Sijera Leone uz negativan PCR test, ne stariji od 72 sata, i dozvolu putovanja koja se dobija preko portala Vlade Sijera Leonea  \n' +
