  ...
  it('should classify the countries', async () => {
    const countriesInfo: CountryInfo[] = [
      ...
      },
      {
        name: 'ARGENTINA',
        info:
          'Državljani Srbije ne mogu ući u Argentinu osim lica koja imaju regulisan boravak u Argentini ili nekoj od pograničnih država, kao i nosioci diplomatskih i službenih pasoša. Neophodan je negativan PCR test, ne stariji od 72 sata. Elektronskim putem se daje izjava o odgovornosti da je putnik upoznat sa svim sanitarnim propisima i procedurama u Argentini. Nosioci diplomatskih i službenih pasoša podležu odgovarajućim sanitarnim procedurama, uključujući obavezan karantin od 14 dana.',
      },
      {
        name: 'AUSTRALIJA',
        info:
      ...
      },
      {
        name: 'BELGIJA',
        info:
          'Državljani Srbije ne mogu da uđu u Belgiju. Ulazak je dozvoljen samo licima koja imaju regulisan boravak u Belgiji i licima koja imaju suštinski razlog za putovanje, uz odgovarajući dokaz o razlogu putovanja (medicinski radnici, visokokvalifikovani radnici čije prisustvo je neophodno, studenti, lica koja putuju iz hitnih porodičnih razloga (spajanje porodice, poseta supružniku ili vanbračnom partneru, poseta u kontekstu zajedničkog roditeljstva, putovanja radi venčanja ili sahrane za prvi ili drugi stepen srodstva i sl.), lica koja dolaze na sastanke koje organizuju međunarodne organizacije i sl). Dozvola se dobija preko Ambasade Belgije u Beogradu. Za sve putnike koji dolaze iz tzv. crvene zone (u kojoj se nalazi i Srbija) obavezno je testiranje po dolasku. Obaveštenje o obavezi samoizolacije se dobija SMS porukom.  Samoizolacija traje deset dana. Svi putnici imaju obavezu da popune Public Health Passenger Locator Form, 48 sati pre ulaska u Belgiju. Nakon popunjavanja obrasca, putnici će dobiti e-mejl sa QR kodom. Svi putnici imaju obavezu da popune Public Health Passenger Locator Form, 48 sati pre ulaska u Belgiju. Nakon popunjavanja obrasca, putnici će dobiti SMS poruku sa kodom za testiranje. Tranzit je dozvoljen, uz obavezu popunjavanja Public Health Passenger Locator Form. Ukoliko tranzit obuhvata određeno vreme boravka na teritoriji Belgije, lice koje tranzitira, to vreme mora provesti u samoizolaciji. Više informacija je dostupno na  <a href="https://www.info-coronavirus.be/en/faq/#faq" class="text-info" target="_blank" rel="noopener noreferrer">https://www.info-coronavirus.be/en/faq/#faq</a>  i  <a href="https://dofi.ibz.be/sites/dvzoe/EN/Pages/Travel-to-Belgium.aspx" class="text-info" target="_blank" rel="noopener noreferrer">https://dofi.ibz.be/sites/dvzoe/EN/Pages/Travel-to-Belgium.aspx</a> , gde se može preuzeti i Public Health Passenger Locator Form.',
      },
      {
        name: 'BELIZE',
        info:
      ...
      },
      {
        name: 'BRAZIL',
        info:
          'Državljani Srbije mogu da uđu u Brazil vazdušnim putem. Strani državljani ne mogu da uđu u Brazil kopnenim i vodenim putevima.',
      },
      {
      ...
      },
      {
        name: 'KATAR',
        info:
          'Državljani Srbije mogu da uđu u Katar uz prethodno dobijenu dozvolu preko „Qatar Portal". Po dolasku, obavezno je testiranje na aerodomu „Hamad" nakon čega sledi jednonedeljni karantin u hotelu. Majke sa decom do 5 godina, deca do te dobi i hronični bolesnici idu samo u kućni karantin. Državljani Srbije mogu u Katar ući bez karantina, ako putuju preko Istanbula, ali je neophodno da pribave negativan test u jednoj od ovlašćenih turskih laboratorija, kao i da provedu u Istanbulu minimalno nedelju dana. Labaratorije su Istanbul University of Health Science-Sultan Suleyman Legal Hospital, Jarrah Pasha Hospital, Pashak Sehir Cham and Sakura Hospital, Kartal Lotfi Kirdar Hospital. Svi putnici moraju imati instaliranu aplikaciju „EHTERAZ". Tranzit preko aerodroma Hamad je dozvoljen.',
      },
      {
        name: 'KENIJA',
        info:
      ...
      },
      {
        ...
        info:
          'Državljani Srbije mogu da uđu u Saudijsku Arabiju. Za ulazak stranih državljana je neophodna boravišna dozvola (iqama) sa važećom vizom ili neka od sledećih viza: poslovna, radna ili za posetu (business, work or visit visa). Obavezan je negativan PCR test, ne stariji od 72 sata, izdat od laboratorije akreditovane od strane Ministarstva zdravlja Saudijske Arabije. Potrebno je kontaktirati diplomatsko-konzularno predstavništvo Saudijske Arabije za listu laboratorija.',
      },
      {
        name: 'SVETA LUCIJA',
        info:
      ...
      },
      {
        name: 'TURSKA',
        info:
          'Državljani Srbije mogu ući u Tursku bez negativnog PCR testa. Pri ulasku u zemlju postoji obavezni lekarski pregled i merenje temperature. Popunjava se formular sa ličnim podacima, kontaktom i adresom boravka. Ukoliko se na lekarskom pregledu pokažu simptomi, Direkcija za zdravstvo prevozi lice u najbližu zdravstvenu ustanovu u kojoj će se raditi test. Turska ne pokriva bolničko lečenje od korona virusa ukoliko se lice zarazi tokom turističkog boravka u Turskoj. Svi strani državljani mogu ući u Tursku pod istim uslovima. Za članove diplomatskih misija obavezno je najavljivanje dolaska u zemlju putem verbalne note, tri radna dana pre dolaska, u kojoj će se navesti datum, granični prelaz i način putovanja (ukoliko je let, podaci leta, ukoliko je kopnenim putem, podaci vozila).',
      },
      {
        name: 'TURKMENISTAN',
        info:
      ...
      },
      {
        name: 'HOLANDIJA',
        info:
          'Državljani Srbije ne mogu da ulaze u Holandiju ukoliko nemaju regulisan boravak ili ukoliko ne potpadaju pod neki od izuzetaka od zabrane ulaska u Holandiju. Licima koja potpadaju pod izuzetak od zabrane putovanja i koja dolaze iz Srbije se savetuje da budu u kućnom karantinu u trajanju od 10 dana. Dozvoljava se ulazak licima koja imaju neodložnu i hitnu potrebu da posete svoje porodice (neizlečiva bolest ili u slučaju sahrane), osobama kojima je potrebna međunarodna zaštita, osobama koje se primaju iz humanitarnih razloga, studentima, visoko obrazovanim migrantima i osobama koje su u emotivnoj vezi sa holandskim državljanima. Od 15. decembra 2020. godine od 18:00 časova, za pojedine kategorije lica biće neophodno da poseduju negativan test, ne stariji od 72 sata. Potrebno je da to bude molekularni PCR test i test na Sars-Cov-2/COVID-19. Drugi tipovi testa, uključujući brzi test, se ne prihvataju. Navedena odluka se odnosi na osobe (starije od 13 godina) koje dolaze u Holandiju iz neke od zemalja koje nisu uključene na listu EU na kojoj su navedene epidemološki bezbedne zemlje. Obaveza posedovanja negativnog testa se, između ostalih, ne odnosi na lica koja imaju regulisan boravak u Holandiji i EU i lica koja su u tranzitu preko međunarodne zone aerodroma. Dodatne informacije o proceduri ulaska i izuzecima od zabrane putovanja mogu se naći u sledećem linku:  <a href="https://www.government.nl/topics/coronavirus-covid-19/tackling-new-coronavirus-in-the-netherlands/travel-and-holidays/visiting-the-netherlands" class="text-info" target="_blank" rel="noopener noreferrer">https://www.government.nl/topics/coronavirus-covid-19/tackling-new-coronavirus-in-the-netherlands/travel-and-holidays/visiting-the-netherlands</a> Tranzit je dozvoljen.',
      },
      {
        name: 'HONDURAS',
        info:
